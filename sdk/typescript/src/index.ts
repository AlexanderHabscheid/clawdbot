...
export {
  ...
  type DesktopFindOptions,
  type DesktopClickOptions,
  type DesktopTypeOptions,
  type DesktopAppsOptions,
  type DesktopWindowsOptions,
  type RouteRunApiOptions,
  type RouteRecordStartApiOptions,
  type RouteRecordStopApiOptions,
  type WebMemoryIndexOptions,
  type WebMemoryResolveOptions,
  type WebMemoryExecuteOptions,
  type WebMemoryInvalidateOptions,
  type WebMemoryStatsOptions,

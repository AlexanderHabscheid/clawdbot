...
const formatHotkeyLabel = (key: string): string => {
  if (key === "GLOBE") {
    return "🌐 Fn";
  }
  if (key === "Space") {
    ...
    <div className="p-6 bg-gradient-to-b from-gray-100 to-gray-200 rounded-2xl shadow-2xl border border-gray-300">
      ...
      {selectedKey && (
        <div className="mt-6 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-orange-100 border-2 border-orange-300 rounded-lg">
            <span className="text-sm text-orange-700 mr-2">Selected:</span>
            <kbd className="px-3 py-1 bg-white border border-orange-200 rounded font-mono text-lg font-semibold text-orange-900">

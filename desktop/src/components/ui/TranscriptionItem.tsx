...
export default function TranscriptionItem({
  ...
  return (
    <div className="relative bg-gradient-to-b from-orange-50/30 to-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
      <div className="p-6 pl-16" style={{ paddingTop: "8px" }}>
        <div className="flex items-start justify-between">
          <div className="flex-1 mr-3">
            ...
            >
              <span className="text-orange-600 text-xs font-medium">#{total - index}</span>

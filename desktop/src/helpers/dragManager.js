...
class DragManager {
  ...
  async startWindowDrag() {
    ...
    try {
      ...
      logger.log("Window drag started");
      return { success: true };
    } catch (error) {
      logger.error("Failed to start window drag:", error);
      this.isDragging = false;
  ...
  async stopWindowDrag() {
    try {
      ...
      logger.error("Failed to stop window drag:", error);
      return { success: false, message: error.message };
    }
  }
  ...
  updateWindowPosition() {
    try {
      ...
      logger.error("Error updating window position:", error);
      this.stopWindowDrag();
    }
  }
